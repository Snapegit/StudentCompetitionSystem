				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="生日" prop="shengri">
							<el-input class="list_inp" v-model="form.shengri" placeholder="生日"
								 type="text" 								:readonly="!isAdd||disabledForm.shengri?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shengri'){
					form.value.shengri = row[x];
					disabledForm.value.shengri = true;
					continue;
				}
				if(x=='shenfenzheng'){
