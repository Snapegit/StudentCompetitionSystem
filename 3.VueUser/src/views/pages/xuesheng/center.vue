			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						...
						<el-col :span="12">
							<el-form-item prop="shengri" label="生日">
								<el-input class="list_inp" v-model="userForm.shengri" placeholder="生日" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="duiwumingcheng" label="队伍名称">
								<el-input class="list_inp" v-model="userForm.duiwumingcheng" placeholder="队伍名称" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="pquestion" label="密保问题">
								<el-input class="list_inp" v-model="userForm.pquestion" placeholder="密保问题" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="panswer" label="密保答案">
								<el-input class="list_inp" v-model="userForm.panswer" placeholder="密保答案" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
	...
	const updatePassword = async ()=>{
		passwordFormRef.value.validate(async (valid) => {
			if (valid) {
				var nowpassword = ''
				await context?.$http({
					url:'encrypt/sha-2?text=' + passwordForm.value.mima,
					method: 'get'
				}).then(res=>{
