	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">比赛名称</div>
					<div  class="info_text" >{{detail.bisaimingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">比赛类型</div>
					<div  class="info_text" >{{detail.bisaileixing}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">比赛地点</div>
					<div  class="info_text" >{{detail.bisaididian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">作品名称</div>
					<div  class="info_text" >{{detail.zuopinmingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">队伍名称</div>
					<div  class="info_text" >{{detail.duiwumingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">参加时间</div>
					<div  class="info_text" >{{detail.canjiashijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">作品详情</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.zuopinxiangqing" @click="downClick(detail.zuopinxiangqing)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'成绩')" @click="bisaichengjionAcross('成绩','bisaichengji','','[1]','已录入')" type="warning">成绩</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('canjiabisai','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('canjiabisai','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('canjiabisai','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const bisaichengjionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
